...
@section('title')
<title> Smart General Company | Projects </title>
@endsection
...
<div class="container">
  ...
  <div class="hk-pg-header">
    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="image"></i></span></span>{{ __('Projects') }}</h4>
  </div>
  <!-- /Title -->
  ...
  <div class="row">
    <div class="col-xl-12">
      <section class="hk-sec-wrapper">
        <h5 class="hk-sec-title">{{ __('List of Projects') }}</h5>
        <div class="d-flex align-items-center justify-content-between mb-20">
          <h5 class="hk-sec-title"></h5>
          <a href="#" class="btn btn-dark" data-toggle="modal" data-target="#addProjectsPage">{{ __('Add New Project') }}</a>
        </div>
                ...
                <table id="datable_1" class="table table-hover table-bordered table-responsive" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        @if ($item->status==1)
                        <a href="" onclick="projectscontentsstatus({{ $item->id }})"><input type="checkbox" checked data-toggle="toggle" data-on="{{ __('Active') }}" data-off="{{ __('Inactive') }}" data-onstyle="success" data-offstyle="danger"></a>
                        @else
                        <a href="" onclick="projectscontentsstatus({{ $item->id }})"><input type="checkbox" data-toggle="toggle" data-on="{{ __('Active') }}" data-off="{{ __('Inactive') }}" data-onstyle="success" data-offstyle="danger"></a>
